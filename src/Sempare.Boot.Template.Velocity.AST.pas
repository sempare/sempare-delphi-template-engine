...
type
  ...
  TVelocityFunction = reference to function(const Args: TArray<TVelocityValue>): TVelocityValue;
  PVelocityFunctionInfo = ^TVelocityFunctionInfo;

  TVelocityFunctionInfo = record
    Name: string;
    Signature: string;
    MinArgs, MaxArgs: integer;
    FN: TVelocityFunction;
  end;

  IFunctionCallExpr = interface(IExpr)
    ['{9F83BF0D-DFA2-47A6-BEEB-5A1D0C829BD4}']
    function GetFunctionInfo: TVelocityFunctionInfo;
    function GetExprList: IExprList;
    function Invoke(const AArgs: TArray<TValue>): TValue;

    property FunctionInfo: TVelocityFunctionInfo read GetFunctionInfo;
  ...
  IVelocityVisitor = interface
    ...
    // procedure Visit(const AContainer: IAcceptVelocityVisitor); overload;
    ...
    procedure Visit(const AStmt: IFunctionCallExpr); overload;
    procedure Visit(const AStmt: IMethodCallExpr); overload;
